...
export const floodHotspots = [
    ...
    {
        id: 2,
        name: "Maraouy Underpass",
        location: "Maraouy, Lipa City",
        coordinates: [13.9456, 121.1512],
        waterLevel: 45,
        status: "warning",
        lastUpdate: new Date().toISOString(),
    },
    {
        id: 3,
        name: "Marawoy Creek",
        location: "Marawoy, Lipa City",
        coordinates: [13.9389, 121.1589],
        waterLevel: 82,
        status: "flooded",
        lastUpdate: new Date().toISOString(),
    },
    {
        id: 4,
        name: "Tambo Crossing",
        location: "Tambo, Lipa City",
        coordinates: [13.9512, 121.1678],
        waterLevel: 8,
        status: "clear",
        lastUpdate: new Date().toISOString(),
    },
    ...
    {
        id: 6,
        name: "San Carlos Junction",
        location: "San Carlos, Lipa City",
        coordinates: [13.9478, 121.1723],
        waterLevel: 95,
        status: "flooded",
        lastUpdate: new Date().toISOString(),
    },
    {
        id: 7,
        name: "Bolbok River",
        location: "Bolbok, Lipa City",
        coordinates: [13.9298, 121.1567],
        waterLevel: 12,
        status: "clear",
        lastUpdate: new Date().toISOString(),
    },
    {
        id: 8,
        name: "Dagatan Drainage",
        location: "Dagatan, Lipa City",
        coordinates: [13.9567, 121.1389],
        waterLevel: 38,
        status: "warning",
        lastUpdate: new Date().toISOString(),
    },
